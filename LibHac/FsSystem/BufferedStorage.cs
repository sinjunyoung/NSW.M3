...
public class BufferedStorage : IStorage
{
    ...
    private ref struct SharedCache
    {
        ...
        public void Dispose()
        {
            using ScopedLock<SdkMutexType> lk = new(ref BufferedStorage._mutex);
    ...
    private ref struct UniqueCache
    {
        ...
        public void Dispose()
        {
            if (!_cache.IsNull)
            {
                using ScopedLock<SdkMutexType> lk = new(ref _bufferedStorage._mutex);
    ...
    public override Result SetSize(long size)
    {
        ...
        if (prevSize < size)
        {
            ...
            {
                using SharedCache cache = new(this);
            ...
            if (currentSize <= _blockSize)
            {
                ...
                if (!cache.AcquireNextOverlappedCache(currentOffset, currentSize))
                {
                    ...
                    while (true)
                    {
                        ...
                        using UniqueCache fetchCache = new(this);
