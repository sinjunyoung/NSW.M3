...
#pragma warning restore CS0649
    ...
    public void SetStorage(int index, IStorage storage, long offset, long size)
    {
        ...
        using ValueSubStorage subStorage = new(storage, offset, size);
    ...
    public void FinalizeObject()
    {
        if (IsInitialized())
        {
            ...
            {
                using ValueSubStorage emptySubStorage = new();
    ...
    public override Result Read(long offset, Span<byte> destination)
    {
        ...
        OperatePerEntryClosure closure = new() { OutBuffer = destination, Offset = offset };
    ...
    public Result GetEntryList(Span<Entry> entryBuffer, out int outputEntryCount, long offset, long size)
    {
        ...
        Entry currentEntry = visitor.Get<Entry>();
        ...
        switch (operationId)
        {
            ...
            case OperationId.QueryRange:
                ...
                if (size > 0)
                {
                    ...
                    if (!_table.IsEmpty())
                    {
                        OperatePerEntryClosure closure = new() { OperationId = operationId, InBuffer = inBuffer };
        ...
        ref OperatePerEntryClosure closure, OperatePerEntryFunc func)
    {
        ...
        long endOffset = offset + size;
        BucketTree.ContinuousReadingInfo continuousReading = new();
