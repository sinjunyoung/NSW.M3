...
/// <summary>
/// Represents a code used to report the result of a function.
/// </summary>
[Serializable]
...
public readonly struct Result : IEquatable<Result>
{
    ...
    public readonly struct Base
    {
        ...
        public static implicit operator Result(Base @base) => @base.Value;
        ...
        /// <param name="originalResult">The original <see cref="Result"/> value.</param>
        /// <returns>The <see cref="Result"/> representing the start of this result range.</returns>
        public Result LogConverted(Result originalResult) => Value.LogConverted(originalResult);

        public Result Handle() => Value.Handle();
        public Result Rethrow() => Value.Rethrow();
        public Result Catch() => Value.Catch();
        public Result Miss() => Value.Miss();
