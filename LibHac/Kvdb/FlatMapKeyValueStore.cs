...
public class FlatMapKeyValueStore<TKey> : IDisposable where TKey : unmanaged, IEquatable<TKey>, IComparable<TKey>
{
        ...
        MemoryResource memoryResource, MemoryResource autoBufferMemoryResource)
    {
        ...
        U8StringBuilder sb = new(_archivePath.Get());
    ...
    public Result Save()
    {
        ...
        try
        {
            ...
            KeyValueArchiveBufferWriter writer = new(span);
            SaveTo(ref writer);
    ...
    {
        KeyValueArchiveBufferReader reader = new(buffer);
    ...
    {
        U8Span path = new(_archivePath.Get());
    ...
    {
        KeyValueArchiveSizeCalculator calculator = new();
