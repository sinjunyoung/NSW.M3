...
public static class ResultKvdb
{
    ...
    public static Result.Base OutOfKeyResource => new(ModuleKvdb, 1);
    /// <summary>Error code: 2020-0002; Inner value: 0x414</summary>
    public static Result.Base KeyNotFound => new(ModuleKvdb, 2);
    /// <summary>Error code: 2020-0004; Inner value: 0x814</summary>
    public static Result.Base AllocationFailed => new(ModuleKvdb, 4);
    /// <summary>Error code: 2020-0005; Inner value: 0xa14</summary>
    public static Result.Base InvalidKeyValue => new(ModuleKvdb, 5);
    /// <summary>Error code: 2020-0006; Inner value: 0xc14</summary>
    public static Result.Base BufferInsufficient => new(ModuleKvdb, 6);
    /// <summary>Error code: 2020-0008; Inner value: 0x1014</summary>
    public static Result.Base InvalidFileSystemState => new(ModuleKvdb, 8);
    /// <summary>Error code: 2020-0009; Inner value: 0x1214</summary>
    public static Result.Base NotCreated => new(ModuleKvdb, 9);
}