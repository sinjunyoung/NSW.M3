...
public class LayeredFileSystem : IFileSystem
{
    ...
    /// </summary>
    private List<IFileSystem> Sources { get; } = new();
        ...
        OpenDirectoryMode mode)
    {
        ...
        if (multipleSources is not null)
        {
            using UniqueRef<MergedDirectory> dir = new(new MergedDirectory(multipleSources, mode));
        ...
        {
            using UniqueRef<IDirectory> dir = new();
    ...
    private class MergedDirectory : IDirectory
    {
        ...
        private HashSet<string> Names { get; } = new();
