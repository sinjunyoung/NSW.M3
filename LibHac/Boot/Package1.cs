...
public class Package1
{
    ...
    private Result InitMarikoBodyStorage()
    {
        ...
        SubStorage bodySubStorage = new(in _baseStorage, Unsafe.SizeOf<Package1MarikoOemHeader>(), bodySize);
        ...
        if (IsDecrypted)
        {
            AesCbcStorage decStorage = new(bodySubStorage, KeySet.MarikoBek, _metaData.Iv, true);
            CachedStorage cachedStorage = new(decStorage, 0x4000, 1, true);
    ...
    private Result SetPk11Storage()
    {
        ...
        SubStorage encPk11Storage = new(_bodyStorage, pk11Offset, Pk11Size);
    ...
    private bool TryFindEristaKeyRevision()
    {
        ...
        Package1Pk11Header decHeader = new();
    ...
    public IStorage OpenDecryptedWarmBootStorage()
    {
        ...
        SubStorage plainTextSection = new(warmBootStorage, 0, MarikoWarmBootPlainTextSectionSize);
        SubStorage encryptedSubStorage = new(warmBootStorage, MarikoWarmBootPlainTextSectionSize, encryptedSectionSize);
