...
public class Package2StorageReader : IDisposable
{
    ...
    public Result OpenPayload(ref UniqueRef<IStorage> outPayloadStorage, int index)
    {
        ...
        SubStorage payloadSubStorage = new(in _storage, offset, size);
    ...
    public Result OpenIni(ref UniqueRef<IStorage> outIniStorage)
    {
        ...
        using UniqueRef<IStorage> kernelStorage = new();
    ...
    {
        using (RentedArray<byte> buffer = new(0x10000))
        {
            byte[] array = buffer.Array;
            Buffer32 hashBuffer = new();
    ...
    public Result OpenDecryptedPackage(ref UniqueRef<IStorage> outPackageStorage)
    {
        ...
        // Open decrypted meta
        SubStorage encMetaStorage = new(in _storage, unencryptedHeaderSize, encryptedHeaderSize);
        ...
        for (int i = 0; i < Package2Header.PayloadCount; i++)
        {
            ...
            using UniqueRef<IStorage> payloadStorage = new();
