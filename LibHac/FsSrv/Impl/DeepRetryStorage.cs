...
public class DeepRetryStorage : IStorage
{
    ...
    private Result InvalidateCacheOnStorage(bool remount)
    {
        ...
        using UniqueLock<ReaderWriterLock> scopedWriterLock = new(_readWriteLock);
        ...
        using SharedRef<IStorage> remountStorage = new();
        using SharedRef<IAsynchronousAccessSplitter> remountStorageAccessSplitter = new();
