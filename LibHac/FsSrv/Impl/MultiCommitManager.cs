...
internal class MultiCommitManager : IMultiCommitManager
{
    ...
    {
        using SharedRef<IFileSystem> contextFileSystem = new();
    ...
    public Result Add(ref readonly SharedRef<IFileSystemSf> fileSystem)
    {
        ...
        using SharedRef<IFileSystem> fsaFileSystem = new();
    ...
    private Result Commit(IFileSystem contextFileSystem)
    {
        ...
        using ContextUpdater contextUpdater = new(contextFileSystem);
    ...
    {
        using Path contextFilePath = new();
