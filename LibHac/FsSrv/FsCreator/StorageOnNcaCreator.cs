...
public class StorageOnNcaCreator : IStorageOnNcaCreator
{
    ...
    {
        NcaFileSystemDriver ncaFsDriver = new(in ncaReader, _memoryResource, _bufferManager, _hashGeneratorFactorySelector);
        ...
        using SharedRef<RomResultConvertStorage> resultConvertStorage = new(new RomResultConvertStorage(in storage));
    ...
    public Result CreateWithPatch(ref SharedRef<IStorage> outStorage,
        ...
        int fsIndex)
    {
        NcaFileSystemDriver ncaFsDriver = new(in originalNcaReader, in currentNcaReader, _memoryResource,
