...
internal class PatrolReader
{
    ...
    {
        using PooledBuffer pooledBuffer = new(_patrolStateSize, 1);
    ...
    {
        using PooledBuffer pooledBuffer = new(_patrolReadSize, 1);
        using ScopedLock<SdkMutex> scopedLock = ScopedLock.Lock(ref _mutex);
    ...
    private void PatrolReaderThread()
    {
        ...
        using TimerEvent timer = new(_sdmmc.Hos.Os, EventClearMode.AutoClear);
