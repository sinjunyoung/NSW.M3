...
internal class MmcManager : IStorageDeviceManager, IStorageDeviceOperator, ISdmmcDeviceManager
{
    ...
    {
        MmcManager manager = new(sdmmc);

        using SharedRef<MmcManager> sharedManager = new(manager);
    ...
    {
        using UniqueLockRef<SdkMutexType> scopedLock = new(ref _mutex.GetBase());
    ...
    {
        MmcManagerOperationIdValue operation = (MmcManagerOperationIdValue)operationId;
