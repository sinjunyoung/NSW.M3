...
public class MetaLoader
{
    ...
    public ulong ProgramId
    {
        get
        {
            GetNpdm(out Npdm npdm).ThrowIfFailure();
    ...
    public Result LoadFromFile(IFileSystem fileSystem, string path = "/main.npdm")
    {
