...
public readonly struct BlitStruct<T> where T : unmanaged
{
    ...
    /// <summary>
    /// Returns a new <see cref="BlitStruct{T}"/> with the element count set to 0.
    /// </summary>
    public static BlitStruct<T> Empty => new(0);

    /// <summary>
    /// Returns a new <see cref="BlitStruct{T}"/> with the element count set to 1.
    /// </summary>
    public static BlitStruct<T> Single => new(1);
    ...
    public BlitStruct(int elementCount = 1)
    {
        if (elementCount <= 0)
