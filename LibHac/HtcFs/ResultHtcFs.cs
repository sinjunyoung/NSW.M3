...
public static class ResultHtcFs
{
    ...
    public static Result.Base InvalidArgument => new(ModuleHtcFs, 3);

    /// <summary>Error code: 2031-0100; Range: 100-199; Inner value: 0xc81f</summary>
    public static Result.Base ConnectionFailure => new(ModuleHtcFs, 100, 199);
        /// <summary>Error code: 2031-0101; Inner value: 0xca1f</summary>
        public static Result.Base HtclowChannelClosed => new(ModuleHtcFs, 101);

        /// <summary>Error code: 2031-0110; Range: 110-119; Inner value: 0xdc1f</summary>
        public static Result.Base UnexpectedResponse => new(ModuleHtcFs, 110, 119);
            /// <summary>Error code: 2031-0111; Inner value: 0xde1f</summary>
            public static Result.Base UnexpectedResponseProtocolId => new(ModuleHtcFs, 111);
            /// <summary>Error code: 2031-0112; Inner value: 0xe01f</summary>
            public static Result.Base UnexpectedResponseProtocolVersion => new(ModuleHtcFs, 112);
            /// <summary>Error code: 2031-0113; Inner value: 0xe21f</summary>
            public static Result.Base UnexpectedResponsePacketCategory => new(ModuleHtcFs, 113);
            /// <summary>Error code: 2031-0114; Inner value: 0xe41f</summary>
            public static Result.Base UnexpectedResponsePacketType => new(ModuleHtcFs, 114);
            /// <summary>Error code: 2031-0115; Inner value: 0xe61f</summary>
            public static Result.Base UnexpectedResponseBodySize => new(ModuleHtcFs, 115);
            /// <summary>Error code: 2031-0116; Inner value: 0xe81f</summary>
            public static Result.Base UnexpectedResponseBody => new(ModuleHtcFs, 116);

    /// <summary>Error code: 2031-0200; Range: 200-299; Inner value: 0x1901f</summary>
    public static Result.Base InternalError { [MethodImpl(MethodImplOptions.AggressiveInlining)] get => new(ModuleHtcFs, 200, 299); }
        /// <summary>Error code: 2031-0201; Inner value: 0x1921f</summary>
        public static Result.Base InvalidSize => new(ModuleHtcFs, 201);
        /// <summary>Error code: 2031-0211; Inner value: 0x1a61f</summary>
        public static Result.Base UnknownError => new(ModuleHtcFs, 211);
        /// <summary>Error code: 2031-0212; Inner value: 0x1a81f</summary>
        public static Result.Base UnsupportedProtocolVersion => new(ModuleHtcFs, 212);
        /// <summary>Error code: 2031-0213; Inner value: 0x1aa1f</summary>
        public static Result.Base InvalidRequest => new(ModuleHtcFs, 213);
        /// <summary>Error code: 2031-0214; Inner value: 0x1ac1f</summary>
        public static Result.Base InvalidHandle => new(ModuleHtcFs, 214);
        /// <summary>Error code: 2031-0215; Inner value: 0x1ae1f</summary>
        public static Result.Base OutOfHandle => new(ModuleHtcFs, 215);
}