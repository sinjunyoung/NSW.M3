...
public struct SaveDataExtraData : IEquatable<SaveDataExtraData>
{
    ...
    {
        return obj is SaveDataExtraData sde && Equals(sde);
    }

    public bool Equals(SaveDataExtraData other)
    {
        return Attribute == other.Attribute &&
               ...
               JournalSize == other.JournalSize &&
               CommitId == other.CommitId &&
               Reserved.AsReadOnlySpan().SequenceEqual(other.Reserved.AsReadOnlySpan());
    }
    ...
    public override int GetHashCode()
    {
        ...
        hashCode.Add((int)FormatType);
        hashCode.Add(DataSize);
        hashCode.Add(JournalSize);
        hashCode.Add(CommitId);
        unsafe
        {
            fixed (byte* reservedPtr = &Reserved.AsReadOnlySpan().GetPinnableReference())
            {
                hashCode.Add((IntPtr)reservedPtr);
            }
        }
