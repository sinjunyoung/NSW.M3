...
public static class FileSystemProxyServiceObject
{
    public static SharedRef<IFileSystemProxy> GetFileSystemProxyServiceObject(this FileSystemClientImpl fs)
    {
        ...
        using InitializationGuard guard = new(ref g.FileSystemProxyServiceObjectInitGuard,
    ...
    private static SharedRef<IFileSystemProxy> GetFileSystemProxyServiceObjectImpl(FileSystemClientImpl fs)
    {
        ...
        using SharedRef<IFileSystemProxy> fileSystemProxy = new();
    ...
    {
        ref FileSystemProxyServiceObjectGlobals g = ref fs.Globals.FileSystemProxyServiceObject;
        using InitializationGuard guard = new(ref g.FileSystemProxyForLoaderServiceObjectInitGuard,
            fs.Globals.InitMutex);
    ...
    {
        using SharedRef<IFileSystemProxyForLoader> fileSystemProxy = new();
    ...
    {
        ref FileSystemProxyServiceObjectGlobals g = ref fs.Globals.FileSystemProxyServiceObject;
        using InitializationGuard guard = new(ref g.ProgramRegistryServiceObjectInitGuard,
            fs.Globals.InitMutex);
    ...
    {
        using SharedRef<IProgramRegistry> registry = new();
