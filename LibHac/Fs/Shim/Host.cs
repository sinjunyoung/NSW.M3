...
public static class Host
{
    ...
    public static Result MountHost(this FileSystemClient fs, U8Span mountName, U8Span path)
    {
        ...
        using UniqueRef<HostCommonMountNameGenerator> mountNameGenerator = new();
    ...
    public static Result MountHostRoot(this FileSystemClient fs)
    {
        ...
        {
            using UniqueRef<ICommonMountNameGenerator> mountNameGenerator = new(new HostRootCommonMountNameGenerator());
    ...
    public static void UnmountHostRoot(this FileSystemClient fs)
    {
        ...
        U8Span mountName = new(HostRootFileSystemMountName);
