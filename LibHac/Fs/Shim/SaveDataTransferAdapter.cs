...
public class SaveDataExporterVersion2 : ISaveDataDivisionExporter
{
    ...
    {
        using SharedRef<FsSrv.Sf.ISaveDataChunkIterator> iteratorObject = new();
    ...
    {
        using SharedRef<FsSrv.Sf.ISaveDataChunkExporter> exporterObject = new();
...
public class SaveDataImporterVersion2 : ISaveDataDivisionImporter
{
    ...
    {
        using SharedRef<FsSrv.Sf.ISaveDataChunkImporter> importerObject = new();
